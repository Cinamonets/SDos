...
os_main:
	...
	mov es, ax			; segments ever again and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to SD Solentosh!', 0
	os_version_msg		db 'Version ', MIKEOS_VER, 0

	dialog_string_1		db 'Thanks for logging into SD Solentosh!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute SD kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of SD, and', 0
