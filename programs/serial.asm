...
;
; Connect the serial cable to your SD machine and Linux machine.
; Start SD and run SERIAL.BIN, then start your Linux box with the
; above serial terminal entry. On the SD machine, you will see a
...
erase_sub:
	...
	start_msg	db 'SD minicom -- Press F8 to quit', 13, 10, 'Connecting via serial at 9600 baud...', 13, 10, 13, 10, 0
	finish_msg	db 13, 10, 13, 10, 'Exiting SD minicom; press a key to return to SD', 13, 10, 0
