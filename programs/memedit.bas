...
rem Requires SD 1.0b7 or better
...
cmdhelp:
  ...
  print "Memory Manipulator by SD"
  print "Released in 1.0.0"
  print ""
...
title:
  rem >>>titlescreen
  CLS
  PRINT "SD Memory Editor"
  rem PROGSTART is where the program is loaded to on SD this is 32k+editor 
  rem Some OS's that run SDBASIC are different. ramstart is the
...
VariableList:
  ...
  Since SD doesn't check the file before executing it
...
endprog:
  ...
  print "- SD Solentosh Memory Manipulator"
  print "Solentosh Team"
  print "Bye, bye!"
